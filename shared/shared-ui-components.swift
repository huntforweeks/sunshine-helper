...
struct BodyPartPicker: View {
    ...
    @State public var toggle_neck = UserDefaults.standard.object(forKey: "toggle-body-part-neck") != nil ? UserDefaults.standard.bool(forKey: "toggle-body-part-neck") : true
    @State public var toggle_arms = UserDefaults.standard.bool(forKey: "toggle-body-part-arms")
    @State public var toggle_hands = UserDefaults.standard.object(forKey: "toggle-body-part-hands") != nil ? UserDefaults.standard.bool(forKey: "toggle-body-part-hands") : true
