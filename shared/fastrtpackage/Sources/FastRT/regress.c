...
/***********************************/
/* calculate gausscurve at value x */
/***********************************/

double gauss (double x, double mu, double sigma)
{
  double dummy=0;
  dummy = 0.39894228 / sigma * exp (-(x-mu)*(x-mu) / 2.0 / sigma / sigma);
  return dummy;
}
...
/****************************************************/
/*  calculate linear regression of n data points:   */
/*  y = a + b * x;                                  */
/****************************************************/
...
/************************************************************/
/*  calculate linear regression of n WEIGHTED data points:  */
/*  y = a + b * x;                                          */  
